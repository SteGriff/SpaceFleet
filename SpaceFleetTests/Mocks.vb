...
Module Mocks
    ...
    Public Function GetTestPlayer(AllUnits As List(Of ShipOrgUnit)) As Player
        ...
        Return New Player(Team.Human, SomeRace, HomeStar, FirstPlanets, AllUnits)
    ...
    Public Function GetTestEnemyPlayer(AllUnits As List(Of ShipOrgUnit)) As Player
        ...
        Return New Player(Team.Enemy, SomeRace, HomeStar, FirstPlanets, AllUnits)

    End Function

    Public Function GetTestShip() As Ship

        Return New Ship("Fighter", 1, 1, New Integer() {1, 1, 1}, New Integer() {1, 1, 1})
